...
module.exports = {
  ...
  safelist: [
    ...
    'bg-purple-100', 'bg-purple-300', 'bg-purple-50', 'bg-purple-200',
    'bg-white', 'bg-gray-50',
    ...
    'text-purple-600', 'text-purple-800', 'text-purple-900',
    'border-amber-200', 'border-amber-400', 'border-amber-100',
    'border-gray-200', 'border-gray-300',
    'border-green-300', 'border-blue-300', 'border-purple-200',
