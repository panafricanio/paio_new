        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-6">
              <motion.a
                href="https://twitter.com/paioolympiad"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-blue-500 to-blue-600 p-3 rounded-full text-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
              ...
              <motion.a
                href="https://www.facebook.com/paioolympiad"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-indigo-500 to-indigo-600 p-3 rounded-full text-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
              ...
              <motion.a
                href="https://www.instagram.com/paioolympiad"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
