        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <div className="relative w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-orange-100">
                <Image
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSa5ni0kI8dudRRCaG4AcUhlOw3W00tvEcMCQ&s"
                  alt="Maya Chouikrat"
                  fill
                  className="object-cover"
                />
              ...
              <p className="text-gray-600 text-center mb-4">Algerian Olympiad Program</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-center bg-gradient-to-r from-amber-700 to-orange-600 bg-clip-text text-transparent">
                Mr. Mmoloki Lekhutile
              </h3>
              <p className="text-gray-600 text-center mb-4">Botswana</p>
          </motion.div>
            <motion.div
              className="bg-gradient-to-br from-white to-amber-50 border border-amber-100 rounded-xl p-8 shadow-sm hover:shadow-md transition-all"
              variants={fadeInUp}
          ...
          <motion.div
            ...
            >
              ...
              <p className="text-gray-600 text-center mb-4">Egypt</p>
          </motion.div>
          ...
          <motion.div
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-center bg-gradient-to-r from-amber-700 to-orange-600 bg-clip-text text-transparent">
              Mohamed Fares Nebili
              </h3>
              <p className="text-gray-600 text-center mb-4">Tunisia</p>
          </motion.div>
          <motion.div
              className="bg-gradient-to-br from-white to-amber-50 border border-amber-100 rounded-xl p-8 shadow-sm hover:shadow-md transition-all"
              variants={fadeInUp}
