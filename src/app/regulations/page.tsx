          ...
          >
            ...
            >
              <Typography variant="body" className="text-gray-700 max-w-3xl mx-auto">
                Official competition rules and guidelines that applied to the
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 rounded-xl border border-amber-200 bg-amber-50 px-5 py-4 text-amber-900">
            ...
            <p className="text-sm mt-1 text-amber-800">
              Registration is closed. These regulations are retained as the official record of PAIO 2025.
            </p>
          </div>
          <motion.div
          ...
          >
            ...
            >
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between bg-white/80 p-4 rounded-lg border border-amber-100 hover:shadow-md transition-shadow">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-none space-y-3">
                  ...
                  <li className="flex items-start">
                    <span className="h-2 w-2 rounded-full bg-amber-600 mr-3 mt-2.5"></span>
                    <p className="text-lg">
                      Contestants worked individually on problems using their
                      own computers.
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="h-2 w-2 rounded-full bg-amber-600 mr-3 mt-2.5"></span>
                    <p className="text-lg">
                      Solutions were submitted through an online judging
            ...
            >
              ...
              <div className="space-y-4 text-gray-700">
                <p className="text-lg">
                  Individual and team achievements were recognized as
                  follows:
                </p>
                <ul className="list-none space-y-3">
                  <li className="flex items-start">
